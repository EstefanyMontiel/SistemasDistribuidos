...
class TrainerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateTrainers = channel.stream_unary(
                '/trainerpb.TrainerService/CreateTrainers',
...
def add_TrainerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CreateTrainers': grpc.stream_unary_rpc_method_handler(
                    servicer.CreateTrainers,
...
class TrainerService(object):
    ...
    @staticmethod
    def CreateTrainers(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
